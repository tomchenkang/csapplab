...
0000000000400da0 <main>:
  400da0:	53                   	push   %rbx
  400da1:	83 ff 01             	cmp    $0x1,%edi // compare with 1 -->stdin input type
  400da4:	75 10                	jne    400db6 <main+0x16>
  400da6:	48 8b 05 9b 29 20 00 	mov    0x20299b(%rip),%rax        # 603748 <stdin@@GLIBC_2.2.5>
  400dad:	48 89 05 b4 29 20 00 	mov    %rax,0x2029b4(%rip)        # 603768 <infile>
  400db4:	eb 63                	jmp    400e19 <main+0x79>
  400db6:	48 89 f3             	mov    %rsi,%rbx
  400db9:	83 ff 02             	cmp    $0x2,%edi // compare with 2 -->stdin input type
  ...
  400df8:	48 8b 16             	mov    (%rsi),%rdx  // not 1 or 2 --> input error
  ...
  400e19:	e8 84 05 00 00       	callq  4013a2 <initialize_bomb> // initial function
  400e1e:	bf 38 23 40 00       	mov    $0x402338,%edi           // get the input1
  400e23:	e8 e8 fc ff ff       	callq  400b10 <puts@plt>
  400e28:	bf 78 23 40 00       	mov    $0x402378,%edi
  400e2d:	e8 de fc ff ff       	callq  400b10 <puts@plt>
  400e32:	e8 67 06 00 00       	callq  40149e <read_line>
  400e37:	48 89 c7             	mov    %rax,%rdi
  400e3a:	e8 a1 00 00 00       	callq  400ee0 <phase_1>       // test the bomb1
  400e3f:	e8 80 07 00 00       	callq  4015c4 <phase_defused>
  400e44:	bf a8 23 40 00       	mov    $0x4023a8,%edi         // get the input2 store in rdi
...
0000000000400ee0 <phase_1>:
  ...
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi     //寄存器中存放指针地址
  400ee9:	e8 4a 04 00 00       	callq  401338 <strings_not_equal> //调用函数检测
...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp       // allocate 40bit space
  400f02:	48 89 e6             	mov    %rsp,%rsi        // pass the pointer parameter
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>  //skip this call,if not there will throw a bug
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)      // the first must be 1  
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax
  400f1a:	01 c0                	add    %eax,%eax        // the last multiple 2
  400f1c:	39 03                	cmp    %eax,(%rbx)      // compare last*2 == now or not
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx        // the next number
  400f29:	48 39 eb             	cmp    %rbp,%rbx        // the condition end the loop
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx   // the second
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp  // the last
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx   // rsp+12
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx   // rsp+8
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi   // we can get info: enter two number
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax  // judge the input digit numbers > 1
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) // rsp+8 compare with 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8) // 0x402470 store addr 400f7c
  ...
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax          // ? 0x0(0)
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax        // 1 0x137(311)
...
0000000000400fce <func4>:   // 二分法找数的步骤 0~0xe
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax  // edx the up boundary
  400fd4:	29 f0                	sub    %esi,%eax  // esi the down boundary, get the length of the boundary
  400fd6:	89 c1                	mov    %eax,%ecx
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx // logical shift right 31 bit
  400fdb:	01 c8                	add    %ecx,%eax
  400fdd:	d1 f8                	sar    %eax       // algorithm shift right 1 bit
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx // ecx store the mid of the boundary
  400fe2:	39 f9                	cmp    %edi,%ecx  
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>  // ecx <= edi
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx      // the up boundary = mid - 1
  ...
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi       // the down boundary = mid + 1
...
000000000040100c <phase_4>:
  ...
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi   // read format "%d %d"--> two integer
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax        // judge the inputs are two int or not
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)
  401033:	76 05                	jbe    40103a <phase_4+0x2e>  // first int <= 0xe (unsign)
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx
  40103f:	be 00 00 00 00       	mov    $0x0,%esi
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi
  401048:	e8 81 ff ff ff       	callq  400fce <func4>
  40104d:	85 c0                	test   %eax,%eax              // get the recurse time (if one eax = 0)
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)         // the second input is 0
...
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx
  401063:	48 83 ec 20          	sub    $0x20,%rsp       // allocate space
  401067:	48 89 fb             	mov    %rdi,%rbx        // the rbx store the addr of the input string
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)  // the guard value(canary) stored in rsp+0x18
  401078:	31 c0                	xor    %eax,%eax
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax        // the string length is 6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx   // do zero extension (get the first character of the string)
  40108f:	88 0c 24             	mov    %cl,(%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx
  401096:	83 e2 0f             	and    $0xf,%edx            // mod 0xf to find the corresponding character in the 
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx  // there exist a secret comparison table from 0~0xf
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)  // the rsp + i store the i-th compared character
  4010a4:	48 83 c0 01          	add    $0x1,%rax              // rax++
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax            // the up boundary of the rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)    // add end of string to the converted string
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi     //  this is the addr of the test string
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>  // read six number


  40110b:	49 89 e6             	mov    %rsp,%r14
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                 // r12d initial value is 0
  401114:	4c 89 ed             	mov    %r13,%rbp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  40111b:	83 e8 01             	sub    $0x1,%eax                  // exclude the case input has 0
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34>      // every input should <= 6
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d                 // r12d++
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d                 // r12d < 6
  401130:	74 21                	je     401153 <phase_6+0x5f>      // have visited all the input
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax         // each input should not equal to the number after it
  ...
  40114d:	49 83 c5 04          	add    $0x4,%r13             // access to the next input number
  ...
  401162:	2b 10                	sub    (%rax),%edx          // 7 - *rsp+i
  401164:	89 10                	mov    %edx,(%rax)          // *rsp+i = 7 - *rsp+i
  401166:	48 83 c0 04          	add    $0x4,%rax            // visit the next one
  40116a:	48 39 f0             	cmp    %rsi,%rax            // the array boundary rsp+0x18
  ...
  40117d:	39 c8                	cmp    %ecx,%eax          // get the corresponding addr 0x6032d0 + 8 * ecx
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) // push corresponding addr where correspond with rsi 
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi         // the boundary of the cycle
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx // get the position rsi of the input
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>  // if not the first, need to process to get the corresponding addr
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>


  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx    // the head node addr   
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax    // the down boundary
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi    // the up boundary
  4011ba:	48 89 d9             	mov    %rbx,%rcx
  4011bd:	48 8b 10             	mov    (%rax),%rdx
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)     // put the next node addr into the last one's node
  4011c4:	48 83 c0 08          	add    $0x8,%rax          // rax++ to get the next addr of the node
  4011c8:	48 39 f0             	cmp    %rsi,%rax          // have visit all the array
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx          // the addr of the last node
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>


  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)     // add null pointer to the end of the linklist
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp          // the initial of ebp == 5
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax     // initial rbx store the addr of head node
  4011e3:	8b 00                	mov    (%rax),%eax        // get the addr of the next node
  4011e5:	39 03                	cmp    %eax,(%rbx)        // the last node >= next node
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx     // visit the next node
...
0000000000401204 <fun7>:
  ...
  401208:	48 85 ff             	test   %rdi,%rdi    // rdi == 0/null; return -1
  40120b:	74 2b                	je     401238 <fun7+0x34>
  40120d:	8b 17                	mov    (%rdi),%edx
  40120f:	39 f2                	cmp    %esi,%edx
  401211:	7e 0d                	jle    401220 <fun7+0x1c> // linklist node <= esi
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi    // get the first link to search linklist
  401217:	e8 e8 ff ff ff       	callq  401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax         // return * 2
  40121e:	eb 1d                	jmp    40123d <fun7+0x39>
  401220:	b8 00 00 00 00       	mov    $0x0,%eax
  401225:	39 f2                	cmp    %esi,%edx
  401227:	74 14                	je     40123d <fun7+0x39>
  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi  // get the second link to search linklist
  40122d:	e8 d2 ff ff ff       	callq  401204 <fun7>
  401232:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax  // return = rax * 2 +1
...
0000000000401242 <secret_phase>:
  ...
  401255:	e8 76 f9 ff ff       	callq  400bd0 <strtol@plt>  // str to long integer
  40125a:	48 89 c3             	mov    %rax,%rbx
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax    //rax - 1 <= 0x3e8(1000)
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi // one node addr of the linklist
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx  // the memory store the input string
  40133f:	48 89 f5             	mov    %rsi,%rbp  // the memory store the test string
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length> //get input string length
  401347:	41 89 c4             	mov    %eax,%r12d   // the length put in r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi  //(%rdi pass the string)
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length> //get the test string length
  401352:	ba 01 00 00 00       	mov    $0x1,%edx
  401357:	41 39 c4             	cmp    %eax,%r12d   // use the same length string to get through the test
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>
  40135c:	0f b6 03             	movzbl (%rbx),%eax  // now we can ensure the test string store in (%rbp)
                                                    // use commander: (gdb) x/3sb %rbp(0x402400) to get the test string
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp     // the rdi store the parameter from the level 0 (main func)
  401460:	48 89 f2             	mov    %rsi,%rdx      // the rdx store rsi (rsi store the allocate addr--phase_2 func)
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx // the rcx store rsi+4
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp) // the rsp+8 store rsi+20
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax
  401474:	48 89 04 24          	mov    %rax,(%rsp)    // the rsp store rsi+16
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9  // the r9 store rsi+12
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8  // the r8 store rsi+8
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi
  401485:	b8 00 00 00 00       	mov    $0x0,%eax
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  40148f:	83 f8 05             	cmp    $0x5,%eax      // the input number must > 5
...
00000000004015c4 <phase_defused>:
  ...
  4015d8:	83 3d 81 21 20 00 06 	cmpl   $0x6,0x202181(%rip)        # 603760 <num_input_strings>
                                                              // 0x603760 = 0x202181 + 0x4015df, the secret phase is the six one
  4015df:	75 5e                	jne    40163f <phase_defused+0x7b>
  4015e1:	4c 8d 44 24 10       	lea    0x10(%rsp),%r8   // phase_6 5-th input
  4015e6:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx   // phase_6 4-th input
  4015eb:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx   // phase_6 3-th input
  4015f0:	be 19 26 40 00       	mov    $0x402619,%esi   // format "%d %d %s"
  4015f5:	bf 70 38 60 00       	mov    $0x603870,%edi   // input string3 "7 0"
  4015fa:	e8 f1 f5 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  4015ff:	83 f8 03             	cmp    $0x3,%eax
  401602:	75 31                	jne    401635 <phase_defused+0x71>
  401604:	be 22 26 40 00       	mov    $0x402622,%esi   // string "DrEvil" should in string3
